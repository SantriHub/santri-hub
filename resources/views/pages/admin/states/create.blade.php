...
<div class="page-content-wrapper border">
    ...
    <div class="row">
        <div class="col-12 d-sm-flex justify-content-between align-items-center">
            <h1 class="h3 mb-2 mb-sm-0">Add a State</h1>
        </div>
    </div>
                    ...
                    <div class="border-0">
                       <form action="{{route('states.store')}}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="state_name" id="exampleFormControlInput1" placeholder="Input State Name" required>
                          </div>
                          <div class="mb-3">
