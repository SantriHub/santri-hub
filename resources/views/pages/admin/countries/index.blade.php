...
<div class="page-content-wrapper border">
    ...
    <div class="row">
        <div class="col-12 d-sm-flex justify-content-between align-items-center">
            <h1 class="h3 mb-2 mb-sm-0">Data Countries</h1>
            <a  href="{{route('countries.create')}}" class="btn btn-sm btn-primary mb-0" >Add a Country</a>
        </div>
        <br> <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                                <h6 class="mb-0"><a href="#" class="stretched-link"> {{$item->country_name}} </a></h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('countries.edit', $item->id) }}" class="btn btn-success-soft btn-round me-1 mb-1 mb-md-0 button-update" >
