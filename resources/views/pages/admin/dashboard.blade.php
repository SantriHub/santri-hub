                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between position-relative">
                        <div class="d-sm-flex">
                            ...
                            <div class="avatar avatar-md flex-shrink-0">
                                <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/09.jpg')}}" alt="avatar">
                            </div>
                            <!-- Info -->
                    ...
                    <div class="d-flex justify-content-between position-relative">
                        <div class="d-sm-flex">
                            <!-- Avatar -->
                            <div class="avatar avatar-md flex-shrink-0">
                                <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/04.jpg')}}" alt="avatar">
                            </div>
                            <!-- Info -->
                            <div class="ms-0 ms-sm-2 mt-2 mt-sm-0">
                                <h6 class="mb-0"><a href="#" class="stretched-link">Dennis Barrett</a></h6>
