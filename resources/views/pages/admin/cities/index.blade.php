...
<div class="page-content-wrapper border">
    ...
    <div class="row">
        <div class="col-12 d-sm-flex justify-content-between align-items-center">
            <h1 class="h3 mb-2 mb-sm-0">Data Cities</h1>
            <a href="{{route('cities.create')}}" class="btn btn-sm btn-primary mb-0">Add a City</a>
        </div>
                ...
                <div class="tab-pane fade show active" id="nav-html-tab-1">
                    ...
                    <div class="table-responsive border-0">
                        <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                            ...
                            <thead>
                                <tr>
                                    <th scope="col" class="border-0 rounded-start">City Name</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <div class="mb-0 ms-2">
                                                <!-- Title -->
                                                <h6 class="mb-0"><a href="#" class="stretched-link"> {{$item->city_name}} </a></h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('cities.edit', $item->id) }}" class="btn btn-success-soft btn-round me-1 mb-1 mb-md-0 button-update" >
