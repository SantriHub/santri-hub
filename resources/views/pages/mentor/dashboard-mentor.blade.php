...
<section class="pt-0">
	...
	<div class="container-fluid px-0">
		<div class="bg-blue h-100px h-md-200px rounded-0" style="background:url({{ url('template/assets/images/pattern/04.png')}}) no-repeat center center; background-size:cover;">
		</div>
	</div>
					...
					<div class="row d-flex justify-content-between">
						...
						<div class="col-auto mt-4 mt-md-0">
							<div class="avatar avatar-xxl mt-n3">
								<img class="avatar-img rounded-circle border border-white border-3 shadow" src="{{ url('template/assets/images/avatar/01.jpg')}}" alt="">
							</div>
						</div>
						<!-- Profile info -->
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<!-- Image -->
														<div class="w-100px w-md-60px">
															<img src="{{ url('template/assets/images/courses/4by3/10.jpg')}}" class="rounded" alt="">
														</div>
														<!-- Title -->
														<h6 class="mb-0 ms-2">	
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<!-- Image -->
														<div class="w-100px w-md-60px">
															<img src="{{ url('template/assets/images/courses/4by3/04.jpg')}}" class="rounded" alt="">
														</div>
														<!-- Title -->
														<h6 class="mb-0 ms-2">	
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														<!-- Image -->
														<div class="w-100px w-md-60px">
															<img src="{{ url('template/assets/images/courses/4by3/06.jpg')}}" class="rounded" alt="">
														</div>
														<!-- Title -->
														<h6 class="mb-0 ms-2">	
