            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-50 start-0 translate-middle-y mt-n7 d-none d-sm-block">
                        <img src="{{ url('template/assets/images/client/science.svg')}}" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="template/assets/images/client/angular.svg" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-50 end-0 translate-middle-y mt-5 ms-5 d-none d-lg-block z-index-9">
                        <img src="template/assets/images/client/figma.svg" alt="Icon">
                    </div>
                    <!-- Icon logos END -->
                    ...
                    <!-- Active student -->
                    <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(template/assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p class="text-white">Our daily new students</p>
                        <!-- Avatar group -->
                        <ul class="avatar-group mb-0">
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="template/assets/images/avatar/01.jpg" alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="template/assets/images/avatar/02.jpg" alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="template/assets/images/avatar/03.jpg" alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="template/assets/images/avatar/04.jpg" alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                    ...
                    <div class="position-relative">
                        <img src="template/assets/images/element/07.png" alt="">
                    </div>
                </div>
                <!-- Right content END -->
            </div>
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h2 class="fs-1">Most Popular Campus</h2>
            ...
            <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
                ...
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-1" type="button" role="tab" aria-controls="course-pills-tabs-1" aria-selected="false">Dalam Negeri</button>
                </li>
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-2" type="button" role="tab" aria-controls="course-pills-tabs-2" aria-selected="false">Luar Negeri</button>
                </li>
            </ul>
            <!-- Tabs END -->
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                                <img src="template/assets/images/courses/4by3/08.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>Bandung</span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>PTN</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                                <img src="template/assets/images/courses/4by3/02.jpg" class="card-img-top" alt="course image">
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Institut Pertanian Bogor</a></h5>
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    <hr>
                                    <div class="d-flex justify-content-between ">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>Bogor</span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>PTN</span>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Universitas Indonesia</a></h5>
                                    <p class="mb-2 text-truncate-2">Rooms oh fully taken by worse do Points afraid but may end Rooms Points afraid but may end Rooms</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    <hr>
                                    <div class="d-flex justify-content-between ">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>Jakarta</span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>PTN</span>
                                    </div>
                                </div>
                            </div>
                         ...
                         <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Universitas Gajah Mada</a></h5>
                                    <p class="mb-2 text-truncate-2">Rooms oh fully taken by worse do Points afraid but may end Rooms Points afraid but may end Rooms</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    <hr>
                                    <div class="d-flex justify-content-between ">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>Yogyakarta</span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>PTN</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                                <img src="template/assets/images/courses/4by3/05.jpg" class="card-img-top" alt="course image">
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-2">
                                        {{-- <a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Harvard</a></h5>
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>LN</span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>Amerika</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-11 mx-auto position-relative">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-5 text-lg-end">
                                        <a href="/register" class="btn btn-outline-warning mb-0">Start Today</a>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- Row END -->
                ...
                <div class="col-xl-7 order-2 order-xl-1">
                            ...
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="template/assets/images/avatar/09.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="template/assets/images/avatar/04.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="template/assets/images/avatar/02.jpg" alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url(template/assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
