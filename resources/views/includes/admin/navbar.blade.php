        ...
        <div class="d-flex align-items-center w-100">
            ...
            <div class="d-flex align-items-center d-xl-none">
                <a class="navbar-brand" href="index.html">
                    <img class="light-mode-item navbar-brand-item h-30px rounded float-start" src="{{ asset('template/assets/images/logo-mobile-light.png')}}" alt="">
                    <img class="dark-mode-item navbar-brand-item h-30px img-fluid img-thumbnail" src="{{ asset('template/assets/images/logo-mobile-light.png')}}" alt="">
                </a>
            </div>
            <!-- Logo END -->
                ...
                <div class="collapse navbar-collapse w-100" id="navbarTopContent" >
                    ...
                    <div class="nav my-3 my-xl-0 flex-nowrap align-items-center">
                        <div class="nav-item w-100">
                            <form class="position-relative" hidden>
                ...
                <ul class="navbar-nav flex-row align-items-center">
                                    ...
                                    <ul class="list-group list-unstyled list-group-flush">
                                            ...
                                            <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/08.jpg')}}" alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/02.jpg')}}" alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/05.jpg')}}" alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                                        ...
                                        <li>
                                            <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                                <div class="me-3">
                                                    <div class="avatar avatar-md">
                                                        <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/03.jpg')}}" alt="avatar">
                                                    </div>
                                                </div>
                                                <div>
                    ...
                    <li class="nav-item ms-2 ms-md-3 dropdown">
                        ...
                        <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                            <img class="avatar-img rounded-circle" src="{{ asset('template/assets/images/avatar/01.jpg')}}" alt="avatar">
                        </a>
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar me-3">
                                        <img class="avatar-img rounded-circle shadow" src="{{ asset('template/assets/images/avatar/01.jpg')}}" alt="avatar">
                                    </div>
                                    <div>
